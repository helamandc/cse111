...
def main():
    ...
    symbol_quantity_list = parse_formula(chemical_formula.upper(), periodic_table_dict)
    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    molar_mass = compute_molar_mass(symbol_quantity_list, periodic_table_dict)
    # Compute the number of moles in the sample.
    number_moles = mass_sample / molar_mass
    # Print the molar mass.
    print(f"{molar_mass} grams/mole")
    # Print the number of moles.
    print(f"{number_moles:.5f} moles")
    #Print the chemical formula name
    chemical_formula_name_dict = chemical_formula_name()
    if chemical_formula.upper() in chemical_formula_name_dict:
        valid_name = chemical_formula_name_dict[chemical_formula.upper()]
        print(f"The chemical formula name is {valid_name}.")

#This part is for exceeding requirements by creating a dictionary that contains the names of some known chemical formulas
def chemical_formula_name():
    known_molecules_dict = {
    #chemical formula: chemical formula name
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for symbol in symbol_quantity_list:
        ...
        molar_mass = atomic_mass * symbol[QUANTITY_INDEX]
